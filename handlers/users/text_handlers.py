...
def register(message: Message):
    ...
    if us_ex:
        ...
        bot.send_message(
            chat_id,
            f"Введите свои ФИО и номер группы\n"
...
def get_new_user(message: Message):
    ...
    try:
        ...
        bot.send_message(
            chat_id,
            f"Регистрация прошла успешно. Здравствуйте, {first_name}",
...
def cancel_main_menu(message: Message):
    ...
    bot.send_message(
        chat_id,
        "Без регистрации работа невозможно. Для регистрации введите /start",
        reply_markup=ReplyKeyboardRemove(),
    )
...
def start_answer_question(message: Message):
    ...
    if number_of_questions == 1:
        ...
        text = (
            f"Был отправлен вопрос от: {question_student_name}\n"
